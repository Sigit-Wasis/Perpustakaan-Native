...
ob_start();
session_start();
$koneksi = new mysqli ("localhost", "root", "123", "db_perpustakaan");
    ...
    <div class="container">
        <div class="row text-center ">
            <div class="col-md-12">
                ...
                <h5>(Login dahulu untuk mengakses)</h5>
                 <br />
            </div>
        </div>
         <div class="row ">
            ...
            session_start();
                ...
                ?>
                    <script type="text/javascript">
                        alert ("Login Gagal Username dan Password Anda SALAH.......Silahkan Ulangi Kembali")
                    </script>
                <?php
                }
    }
