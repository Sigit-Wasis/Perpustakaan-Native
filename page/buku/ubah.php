    ...
    <div class="row">
        ...
        <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="jumlah" type="number" value="<?php echo $tampil['jumlah_buku']; ?>"/>  
                </div>
...
if ($simpan) {
    ...
    $data = $koneksi->query ("update tb_buku set judul='$judul', pengarang='$pengarang', penerbit='$penerbit', tahun_terbit='$tahun', 
